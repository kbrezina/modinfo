...
public class PPDiagnosticsRunner {
	...
	private class ModuleExport implements AllModuleReferences.Export {
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.IExportsPerModule.Export#getEClass() */
		@Override
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.ExportsPerModule.Export#getFile() */
		@Override
		public File getFile() {
			return file;
		}
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.ExportsPerModule.Export#getLength() */
		@Override
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.ExportsPerModule.Export#getLine() */
		@Override
		public int getLine() {
			return line;
		}
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.IExportsPerModule.Export#getName() */
		@Override
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.IExportsPerModule.Export#getParentName() */
		@Override
		...
		/* (non-Javadoc)
		 * 
		 * @see com.cloudsmith.hammer.puppet.validation.runner.ExportsPerModule.Export#getStart() */
		@Override
		public int getStart() {
			return startOffset;
		}
