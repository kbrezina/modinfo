...
public class JavascriptHrefProducer extends RelativeFileHrefProducer {
	...
	/* (non-Javadoc)
	 * 
	 * @see com.cloudsmith.hammer.puppet.validation.graphs.AbstractHrefProducer#hrefToFileLocation(java.lang.String, int, int,
	 * int) */
	@Override
	...
	/* (non-Javadoc)
	 * 
	 * @see com.cloudsmith.hammer.puppet.validation.graphs.AbstractHrefProducer#hrefToModule(java.lang.String) */
	@Override
	 ...
	 * 
	 * @see
	 * com.cloudsmith.hammer.puppet.validation.graphs.AbstractHrefProducer#hrefToPPTP(com.cloudsmith.hammer.puppet.validation.runner
	 * .AllModuleReferences
	 * .Export) */
	@Override
